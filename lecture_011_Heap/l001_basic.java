...
public class l001_basic {
  ...
  public static void Int_minPQ() {
    PriorityQueue<Integer> pq = new PriorityQueue<>();  // by default min prority queue
    for (int i = 10; i >= 1; i--) pq.add(i * 10);
  ...
  public static void Int_maxPQ(){
    ...
    // other-this, reverse of deafult behavior
  ...
  // rearrange 2d matrix with respect to second column
